...
public:
    ...
    virtual Error present_snapshot(const WorldSnapshot &snapshot) noexcept = 0;
...
public:
    ...
    Error present_snapshot(const WorldSnapshot &snapshot) noexcept override;
