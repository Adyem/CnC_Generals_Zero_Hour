...
#ifndef GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_VISUALC_H
#define GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_VISUALC_H
...
#endif // GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_VISUALC_H
