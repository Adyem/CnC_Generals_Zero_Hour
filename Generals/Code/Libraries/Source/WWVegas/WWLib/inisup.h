...
#ifndef GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_INISUP_H
#define GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_INISUP_H
...
#endif // GENERALS_CODE_LIBRARIES_SOURCE_WWVEGAS_WWLIB_INISUP_H
