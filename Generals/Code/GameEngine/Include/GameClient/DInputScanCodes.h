...
// FILE: DInputScanCodes.h //////////////////////////////////////////////////////
// Description:
//   Minimal reproduction of the DirectInput keyboard scan code constants used
//   throughout the Generals input system.  The original project relied on the
//   Windows SDK header <dinput.h>; however that header is unavailable on
//   non-Windows platforms.  The values defined here match the DirectInput
//   scancodes and allow the existing key tables to compile when building the
//   SFML/Unix port.
////////////////////////////////////////////////////////////////////////////////
...
//---------------------------------------------------------------------------
// Alphanumeric and symbol keys (scan code set 1 values)
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// International/Japanese keyboard keys
//---------------------------------------------------------------------------
...
//---------------------------------------------------------------------------
// Extended keys (prefixed with 0xE0 in the raw scancode stream)
//---------------------------------------------------------------------------
...
#endif // GENERALS_DINPUT_SCANCODES_H_
