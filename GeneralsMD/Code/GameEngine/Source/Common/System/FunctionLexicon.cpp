...
static FunctionLexicon::TableEntry gameWinSystemTable[] = 
{
	...
	{ NAMEKEY_INVALID, "ChallengeMenuSystem",			reinterpret_cast<FunctionLexicon::RawFunctionPointer>(ChallengeMenuSystem) },
...
static FunctionLexicon::TableEntry gameWinInputTable[] = 
{
	...
	{ NAMEKEY_INVALID, "ChallengeMenuInput",			reinterpret_cast<FunctionLexicon::RawFunctionPointer>(ChallengeMenuInput) },
...
static FunctionLexicon::TableEntry winLayoutInitTable[] = 
{
	...
	{ NAMEKEY_INVALID, "ChallengeMenuInit",				reinterpret_cast<FunctionLexicon::RawFunctionPointer>(ChallengeMenuInit) },
...
static FunctionLexicon::TableEntry winLayoutUpdateTable[] = 
{
	...
	{ NAMEKEY_INVALID, "ChallengeMenuUpdate",			reinterpret_cast<FunctionLexicon::RawFunctionPointer>(ChallengeMenuUpdate) },
	...
	{ NAMEKEY_INVALID, "PopupHostGameUpdate",						reinterpret_cast<FunctionLexicon::RawFunctionPointer>(PopupHostGameUpdate) },
...
static FunctionLexicon::TableEntry winLayoutShutdownTable[] = 
{
	...
	{ NAMEKEY_INVALID, "ChallengeMenuShutdown",				reinterpret_cast<FunctionLexicon::RawFunctionPointer>(ChallengeMenuShutdown) },
