...
void Win32GameEngine::update( void )
{
    ...
    // When we are alt-tabbed out the audio backend sometimes needs a nudge to resume
    // updating correctly when focus is restored. This sequence wakes it up nicely.
