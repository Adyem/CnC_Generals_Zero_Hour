...
namespace
{
        constexpr char kRegistryConfigPath[] = "game_zh/registry";
        constexpr char kLegacyRegistryPath[] = "SOFTWARE\\Electronic Arts\\EA Games\\Command and Conquer Generals Zero Hour";
